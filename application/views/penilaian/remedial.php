<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select name="aspek" class="select2 form-control" id="penilaians">
      ...
      <div class="card-footer">
        <div id="result"></div>
        <button type="submit" class="btn btn-sm btn-success btn-icon-split simpan my-3" style="display:none;">
          <span class="icon text-white-50">
            <i class="fas fa-fw fa-save"></i> 
          </span>
          <span class="text">Simpan hasil</span>
        </button>
        <a href="javascript:void(0)" id="rerata_remedial" class="btn btn-sm btn-info btn-icon-split my-3" style="display:none;">
          <span class="icon text-white-50">
            <i class="fas fa-fw fa-save"></i> 
          </span>
