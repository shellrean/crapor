    ...
    <div class="card mb-4">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="hidden" name="base_url" value="<?= base_url('ekskul/store') ?>">

            <div class="form-group">
              <label>Nama eksktrakurikuler</label>
              <input type="text" name="nama_ekskul" placeholder="Masukkan nama eksktrakurikuler" class="form-control" value="<?= set_value('nama_ekskul') ?>" required>
              <?= form_error('nama_ekskul','<small class="form-text text-danger">','</small>') ?>
            </div>

            <div class="form-group">
              <label>Nama ketua</label>
              <input type="text" name="nama_ketua" placeholder="Masukkan nama ketua" class="form-control" value="<?= set_value('nama_ketua') ?>" required>
              <?= form_error('nama_ketua','<small class="form-text text-danger">','</small>') ?>
            </div>

            <div class="form-group">
              <label>Nomor kontak</label>
              <input type="text" name="nomor_kontak" placeholder="Masukkan nomor kontak ekskul" class="form-control" value="<?= set_value('nomor_kontak') ?>" required>
